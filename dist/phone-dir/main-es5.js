...
var AddComponent = /** @class */ (function () {
    function AddComponent(router, compService) {
        this.router = router;
...
var CompService = /** @class */ (function () {
    function CompService() {
        this.contactData = [];
    }
...
var Page1Component = /** @class */ (function () {
    function Page1Component(router, compService) {
        this.router = router;
        this.compService = compService;
        this.phoneData = [];
    }
    ...
    Page1Component.prototype.deleteItem = function (index) {
        this.compService.contactData.splice(index, 1);
    };
    Page1Component.prototype.goto = function () {
